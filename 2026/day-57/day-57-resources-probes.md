...
- My pod have QoS class is Burstable because requests and limits differ
...
- Exit code for OOMkilled container is *137*
...
- It keeps restarting indefinitely as long as the probe keeps failing.
...
- Your app needs 20 seconds to create: /tmp/started But startup probe waits only waits 10 seconds

- So container is killed before it ever becomes healthy
