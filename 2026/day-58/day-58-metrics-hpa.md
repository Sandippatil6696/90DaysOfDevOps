...
-  `kube-apiserver-bankapp-cluster-control-plane`  this pod uses most cpu 
...
- Target column shows cpu current utilization/%cpu utilization limit set for autoscaling  
...
- HPA create 7 replicas to mainatain cpu below 50% 
...
- behavoiur section decides how scaling hppens i.e how pod increases & in how many seconnds - after cpu reaches threshould i.e policies decices this 

- it also decides how to scale down by how many pod in how many seconds i.e policies decides this .
---
