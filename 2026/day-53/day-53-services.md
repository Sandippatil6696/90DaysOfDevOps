...
- The EXTERNAL-IP column in Kubernetes  shows the public IP address that exposes your Service to the outside world.

- on local there is no cloud provider to create a real load balancer
