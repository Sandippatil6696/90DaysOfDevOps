...
**Access Grafana:**
```bash
# open a port 3000 on your local machine or your ec2 instance for incoming traffic for grafana 
...
**Access Prometheus:**
```bash
# Open port 9090 on your local machine or your ec2 instance for incoming traffic
